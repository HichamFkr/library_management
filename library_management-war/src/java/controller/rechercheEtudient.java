 ...
 * @author ASUS
 */
public class rechercheEtudient extends HttpServlet {
    @EJB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Etudient> etudients;
         if(!search.equals("")&&!"".equals(search))
            etudients = etudientServiceImp.getBySearch(search);
        else
            etudients = etudientServiceImp.getAll();
